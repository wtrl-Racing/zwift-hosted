        ...
        10: {
            ...
            points: {
                get: () => Promise.resolve([
                    ...
                    { name: 'Aqueduc Climb Fwd', x: -124459.24, y: -135913.56, image: 'climbstart', rotate: 30 },
                    { name: 'Aqueduc', x: -94242.2, y: -146578.3, image: 'mountain', rotate: 30 },
                    { name: 'Aqueduc Climb Rev', x: -99473.586, y: -172890.92, image: 'climbstart', rotate: 30 },
                ])
            }
        },
        11: {
