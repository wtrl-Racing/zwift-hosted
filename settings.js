        ...
        9: {
            ...
            points: {
                get: () => Promise.resolve([
                    ...
                    { name: 'Country Sprint', x: -61294.54, y: 13331.565, image: 'sprint', rotate: 90, archId: 5 },
                    { name: 'Temple KQOM', x: 0, y: 0, image: 'kom', rotate: 90, archId: 6 },
                    { name: 'Rooftop KQOM', x: -426834.1, y: 96230, image: 'kom', rotate: 90, archId: 7 },
                    { name: 'Railway Sprint', x: -401190.3, y: 43402.43, image: 'sprint', rotate: 90, archId: 8 },
                    ...
                    { name: 'Country Sprint Fwd', x: -68627.04, y: 3546.549, image: 'sprintstart', rotate: 90, segmentlength: 0 },
                    { name: 'Country Sprint Rev', x: -56473.617, y: 25881.627, image: 'sprintstart', rotate: 90, segmentlength: 0 },
                    { name: 'Temple KQOM Fwd', x: 0, y: 0, image: 'climbstart', rotate: 30 },
                    ...
                    { name: 'Tower Sprint Fwd', x: 0, y: 0, image: 'sprintstart', rotate: 90, segmentlength: 0 },
                    { name: 'Tower Sprint Rev', x: 0, y: 0, image: 'sprintstart', rotate: 90, segmentlength: 0 },
                    { name: 'Alley Sprint Fwd', x: 0, y: 0, image: 'sprintstart', rotate: 90, segmentlength: 0 },
